 ...
 */
public class DefaultMapNaviListener implements MapNaviListener {
    ...
    @Override
    public void onTurnInfoUpdated(MapNaviTurnPoint[] mapNaviTurnPoints) {
    ...
    @Override
    public void onGetReachableBoundaryFail(int i) {

    }

    @Override
    public void onGetReachableBoundarySuccess(ReachableBoundaryInfo reachableBoundaryInfo) {

    }

    @Override
    public void onSearchAlongRouteFail(int i) {

    }

    @Override
    public void onSearchAlongRouteSuccess(SearchAlongResult searchAlongResult) {

    }

    @Override
    public void onBatchQueryFail(int i) {

    }

    @Override
    public void onBatchQuerySuccess(List<ChargeStationInfo> list) {
